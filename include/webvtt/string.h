...
typedef struct webvtt_string_list_t webvtt_string_list;

WEBVTT_EXPORT webvtt_status webvtt_create_string_list( webvtt_string_list **string_list );
WEBVTT_EXPORT void webvtt_delete_string_list( webvtt_string_list **string_list );
WEBVTT_EXPORT webvtt_status webvtt_add_to_string_list( webvtt_string_list *string_list, webvtt_string *string );
